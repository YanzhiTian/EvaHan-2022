        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            ...
            while line:
                ...
                for each_pair in line.split(' '):
                    ...
                    if len(temp_label) > 450 and (each_pair[0] == '，' or each_pair[0] == '。'):  # 防止超出最大长度512，如果分割较短的话，这是比较简单的实现方式但并不保险
...
if __name__ == "__main__":
    ...
    dataloader = DataLoader(dataset=data, batch_size=64, shuffle=True, collate_fn=my_collate(label2idx['[PAD]']))
